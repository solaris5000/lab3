...
function Avatar(props) {
  ...
  const [person, setPerson] = useState({
    ...
    surname: 'Салоников',
    group: 'CS-302(c)',
    will: 'DevOps с зарплатой 200к/нс',
    about: 'Люблю искать фисташки и открывать их',
    major:"Отсутствует",
    path:"Был админом, стал сис. админом, стал разрабом",
    phone:"8-800-555-35-35",
    mail:"edu.solaris5000tv@gmail.com",
    yt:"https://www.youtube.com/@Solaris5000",
  });
  ...
  function EditForm()
  {
    return (
      ...
      />
      <div>
        <strong>Мечтает стать:</strong> {person.will}
      </div>
  ...
  function Contacts()
  {
    return(
      ...
      <div>{person.mail}</div>
      <a href={person.yt}>
      <svg className="ytLink" id="yt-logo-updated_yt9" viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
    <g>
